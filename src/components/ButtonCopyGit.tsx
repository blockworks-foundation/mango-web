    ...
    return (
      <>        
        <div
                          ...
                          className=" group cursor-pointer overflow-hidden inline-flex w-full max-h-[40px] shadow-[inset_0_0_30px_rgba(0,0,0,0.3)] bg-dark-theme-bkg-3 border-2 border-th-fgd-3 hover:border-mango-yellow rounded-[12px] transition-all duration-150 ease-in-out">
