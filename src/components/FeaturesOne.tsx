      ...
      <div className="mt-72 mb-8 z-10 max-w-7xl mx-auto p-8">
        ...
        <div className="mt-8 inline-flex">
                        ...
                        <div
                          ...
                          className="group cursor-pointer overflow-hidden inline-flex max-w-md -ml-[130px] shadow-[inset_0_0_30px_rgba(0,0,0,0.6)] bg-dark-theme-bkg-3 border-2 border-th-fgd-3 hover:border-mango-yellow rounded-[12px] transition-all duration-150 ease-in-out">
