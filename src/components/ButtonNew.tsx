...
const ButtonNew: FunctionComponent<LinkieProps> = ({
  ...
  return (
    <div className="cursor-pointer transitions duration-150 ease-in-out relative flex w-[218px] text-th-fgd-3 hover:text-th-fgd-5 bg-th-bkg-2 hover:bg-th-bkg-3 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-th-bkg-4 before:to-transparent before:opacity-0 hover:overflow-hidden hover:before:-translate-x-full hover:before:animate-[shimmer_0.75s_normal] hover:before:opacity-100">
