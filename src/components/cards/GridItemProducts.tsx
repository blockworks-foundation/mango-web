...
function GridItemProducts(props: any) {
  ...
  return (
    <div className="group lg:col-span-1 md:col-span-3 sm:col-span-3 xs:col-span-3 cursor-pointer  transition duration-150 ease-in-out">
      <div className="z-10 bg-th-bkg-2 hover:bg-th-bkg-3 border-2 border-th-fgd-1 h-[380px] w-full shadow-md hover:shadow-[0_8px_62px_-5px_rgba(0,0,0,0.2)] rounded-[28px] bg-mangocardproducts bg-contain bg-top bg-no-repeat transition duration-150 ease-in-out flex justify-items-end place-items-end items-end">
