          ...
          <div className="flex flex-col mb-8">
            <dl className="text-left w-1/2">
                ...
                <div className="grid grid-cols-2 gap-4 saturate-0 group-hover:saturate-100">
                  <div className="inline-flex col-span-1 p-4 bg-th-fgd-1 rounded-2xl mt-3 justify-center">
                  ...
                  <div className="inline-flex col-span-1 p-4 bg-th-fgd-1 rounded-2xl justify-center">
