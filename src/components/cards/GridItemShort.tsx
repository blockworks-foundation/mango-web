...
function GridItemShort(props: any) {
  ...
  return (
    ...
    <div className="z-10 bg-th-bkg-2 hover:bg-th-bkg-3 border-4 border-th-fgd-1 h-[400px] w-full shadow-md hover:shadow-[0_8px_62px_-5px_rgba(0,0,0,0.2)] rounded-[28px] bg-mangocardcoin bg-contain bg-top bg-no-repeat transition duration-150 ease-in-out flex justify-items-end place-items-end items-end">
