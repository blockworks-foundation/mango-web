...
function GridItemShort(props: any) {
  ...
  return (
    <div className="group lg:col-span-1 md:col-span-3 sm:col-span-3 xs:col-span-3 cursor-pointer hover:-translate-y-2 hover:-rotate-1 transition duration-150 ease-in-out">
      <div className="z-10 bg-th-bkg-2 hover:bg-th-bkg-3 border-4 border-th-fgd-1 h-350 w-full shadow-md hover:shadow-[0_8px_62px_-5px_rgba(0,0,0,0.2)] rounded-[28px] bg-mangocardsend bg-contain bg-bottom bg-no-repeat transition duration-150 ease-in-out">
