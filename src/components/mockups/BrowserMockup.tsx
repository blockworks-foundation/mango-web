...
function BrowserMockup(props: any) {
  return (
    <div>
        {/* Browser in CSS */}
        <div className="mt-20 w-[800px] sm:w-[1300px] m-auto rounded-2xl shadow-[0_8px_62px_-5px_rgba(0,0,0,0.25)]">
            ...
            <div className="flex flex-row bg-th-bkg-3 w-full py-4 pl-4 backdrop-blur-xl border border-1 border-solid border-th-fgd-1">
              ...
              <div className="flex flex-row bg-dark-theme-bkg-3 border-2 border-th-fgd-2 rounded-[10px] ml-6">
                          ...
                          <svg 
                            ...
                            <span>
                              <p className="type-url text-xs font-mono ml-1 text-white text-opacity-60 w-[1080px] p-[5px]">
                              </p>
                            </span>
