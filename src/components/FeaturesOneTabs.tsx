    ...
    <Tab.Group manual>
      ...
      <Tab.Panels className={"max-w-7xl mx-auto"}>
        ...
        <div className="mt-20 w-screen m-auto rounded-2xl shadow-xl">
           <div className="bg-white bg-opacity-5 h-14 w-full py-4 pl-4 rounded-t-2xl backdrop-blur-xl border border-1 border-solid border-white border-opacity-10">
          ...
          <div className="flex flex-row bg-white bg-opacity-5 w-full py-4 pl-4 backdrop-blur-xl border border-1 border-solid border-white border-opacity-10">
            <div>
            <ul className="flex flex-row space-x-4">
              ...
              <div className="flex flex-row bg-dark-theme-bkg-3 border-2 border-th-fgd-3 rounded-[10px] ml-6">
