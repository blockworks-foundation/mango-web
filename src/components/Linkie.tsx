        ...
        >
          ...
          <div>
            <svg 
                  ...
                  viewBox="0 0 20 20" 
                  fill="currentColor" 
                  className="w-6 h-6 group-hover:opacity-100 text-mango-yellow opacity-0 transform -translate-x-6 group-hover:translate-x-0 transition duration-100 ease-in-out">
