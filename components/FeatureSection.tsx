  ...
  return (
    <div className="bg-th-bkg-3 transform -skew-y-3 pt-16 pb-32 lg:pb-48 mb-48 lg:mb-48 -mt-64">
      <div className="max-w-7xl mx-auto px-4 transform skew-y-3">
          ...
          <div className="flex flex-wrap -mx-4 mb-6">
            <div className="lg:w-1/3 px-4 mb-6">
              ...
              <p className="text-white text-opacity-50 leading-relaxed text-lg">
                Every market is cross-collateralized. Mango&apos;s risk engine
                let&apos;you utilize all your assets and derivative contracts as
                collateral.
              </p>
            </div>
            ...
            <div className="lg:w-1/3 px-4 mb-6">
              ...
              <p className="text-white text-opacity-50 leading-relaxed text-lg">
                Instant order execution at the price of less than a cent. Low
                latency allows market makers to post tight spreads on the books.
                Oh, and liquidations are instant as well, so watch your
                exposure.
              </p>
            </div>
            <div className="lg:w-1/3 px-4 mb-6">
            ...
            <div className="lg:w-1/3 px-4 mb-6">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M17.5233 0.272298C16.8892 -0.0907658 16.1108 -0.0907658 15.4767 0.272298L1.03954 8.53896C0.0505606 9.10525 -0.293038 10.3677 0.272096 11.3587C0.652378 12.0255 1.34724 12.3996 2.06246 12.4004V26.8667C0.923393 26.8667 0 27.7919 0 28.9333C0 30.0747 0.923393 31 2.06246 31H30.9368C32.0759 31 32.9993 30.0747 32.9993 28.9333C32.9993 27.7919 32.0759 26.8667 30.9368 26.8667V12.4004C31.6523 12.3998 32.3475 12.0258 32.7279 11.3587C33.293 10.3677 32.9494 9.10525 31.9605 8.53896L17.5233 0.272298ZM8.24982 14.4667C7.11076 14.4667 6.18737 15.3919 6.18737 16.5333V22.7333C6.18737 23.8747 7.11076 24.8 8.24982 24.8C9.38889 24.8 10.3123 23.8747 10.3123 22.7333V16.5333C10.3123 15.3919 9.38889 14.4667 8.24982 14.4667ZM14.4372 16.5333C14.4372 15.3919 15.3606 14.4667 16.4996 14.4667C17.6387 14.4667 18.5621 15.3919 18.5621 16.5333V22.7333C18.5621 23.8747 17.6387 24.8 16.4996 24.8C15.3606 24.8 14.4372 23.8747 14.4372 22.7333V16.5333ZM24.7495 14.4667C23.6104 14.4667 22.687 15.3919 22.687 16.5333V22.7333C22.687 23.8747 23.6104 24.8 24.7495 24.8C25.8885 24.8 26.8119 23.8747 26.8119 22.7333V16.5333C26.8119 15.3919 25.8885 14.4667 24.7495 14.4667Z"
                  fill="url(#paint0_linear)"
                />
                <defs>
                  <linearGradient
        ...
        <section className="">
          <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="lg:col-span-1 md:col-span-3 sm:col-span-3 xs:col-span-3">
              <div className="bg-th-fgd-4 border border-bkg-3 bg-product-one bg-cover bg-no-repeat h-650 w-full shadow-md rounded-xl overflow-hidden mx-auto">
            ...
            <div className="lg:col-span-2 md:col-span-3 sm:col-span-3 xs:col-span-3">
              <div className="bg-th-fgd-4 border border-bkg-3 bg-product-two bg-cover bg-no-repeat h-650 w-full shadow-md rounded-xl overflow-hidden mx-auto">
                <div className="py-4 px-8 mt-3">
                  <div className="flex flex-col mb-8">
                    <h2 className="text-yellow-300 font-semibold text-xl tracking-wide mb-2">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="lg:col-span-2 md:col-span-3 sm:col-span-3 xs:col-span-3">
              <div className="bg-th-fgd-4 border border-bkg-3 bg-product-three bg-cover bg-no-repeat h-650 w-full shadow-md rounded-xl overflow-hidden mx-auto">
                <div className="py-4 px-8 mt-3">
                  <div className="flex flex-col mb-8">
                    <h2 className="text-yellow-300 font-semibold text-xl tracking-wide mb-2">
            ...
            <div className="lg:col-span-1 md:col-span-3 sm:col-span-3 xs:col-span-3">
              <div className="bg-th-fgd-4 border border-bkg-3 bg-product-four bg-cover bg-no-repeat h-650 w-full shadow-md rounded-xl overflow-hidden mx-auto">
                <div className="py-4 px-8 mt-3">
                  <div className="flex flex-col mb-8">
                    <h2 className="text-yellow-300 font-semibold text-xl tracking-wide mb-2">
                      Liquidation alert!
        ...
        <div className="bg-gradient-to-br from-th-fgd-4 to-th-fgd-4 border border-bkg-3 rounded-xl shadow-md overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4 mt-8">
