...
const CommunityCard = (props) => (
  <div className="flex col-span-2 xl:col-span-1">
    <div className="flex flex-col bg-th-fgd-4 border border-bkg-3 py-8 px-8 h-auto w-auto shadow-md rounded-xl transform transition duration-200 ease-in-out hover:-translate-y-2 hover:shadow-lg">
      {' '}
      {props.icon}
